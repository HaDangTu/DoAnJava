...
class MenuLanguage extends JMenu{
    ...
    private void createMenuD(){
        ...
        JCheckBoxMenuItem languageDocker = new JCheckBoxMenuItem("Docker");
        languageDocker.addActionListener(langListener);
        languageDocker.setActionCommand(CategoryOfFile.DOCKER_FILE);

...
public class MenuLanguageActionListener  extends MenuMainWindowListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        else if (command.equalsIgnoreCase(CategoryOfFile.DOCKER_FILE)) {
            editorWindow.setEditorStyle(SyntaxConstants.SYNTAX_STYLE_DOCKERFILE);
            resetFileType(CategoryOfFile.DOCKER_FILE);
        }
